      ...
      <div className="row-1">
        ...
        <div className="column">
          <div>
            ...
            />
            {user ? (
              <NavLink to={"https://aaronnewtech.github.io/speech-app/login"}>
                <img
                  id="logout-image"
                  src={
      ...
      <div id="home-page-3">
        ...
        <div className="row-3">
          <div className="column-2">
            <NavLink to="https://aaronnewtech.github.io/speech-app/videos">
              <img
          ...
          <div className="column-2">
            <NavLink to="https://aaronnewtech.github.io/speech-app/speech-practice">
              <img
                id="first-words-logo"
          ...
          <div className="column-2">
            <NavLink to="https://aaronnewtech.github.io/speech-app/rock-paper-scissors-game">
              <img
                id="games-logo"
                src={
                  process.env.PUBLIC_URL +
